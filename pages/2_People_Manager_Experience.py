...
with pexp_col1:
    st.markdown('''
        <div style="text-align: center;">
            ...
            <h1 style="color: #DAF7DC; font-size: 42px; margin: 0;">
                15
            </h1>
        </div>
        ''', unsafe_allow_html=True)
...
# st.markdown('<span style="font-size:14px; color:#FFFFFF">Matthew has had the privilege of building multiple teams and personally hired ~15 staff.</span>', unsafe_allow_html=True)

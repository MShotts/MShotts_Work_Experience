...
st.markdown('<span style="font-size:22px; color:#DAF7DC">Deploying Statistical Models</span>', unsafe_allow_html=True)
with st.expander("Click for details"):
